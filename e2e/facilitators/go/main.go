...
import (
	...
	batchedevm "github.com/x402-foundation/x402/go/mechanisms/evm/batched/facilitator"
...
func isBatchSettlementRequirements(req x402.PaymentRequirementsView) bool {
	...
	return req.GetScheme() == batched.SchemeBatched
}
...
func main() {
	...
	batchedScheme := batchedevm.NewBatchedEvmScheme(evmSigner, batchedAuthorizer)
