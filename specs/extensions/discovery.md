...
A census of 1,971 names by [@meloliva14](https://github.com/meloliva14), 2026-08-23, found
**7 records across 5 operators: 5 non-conforming, and 2 names
belonging to the one operator that conforms (`sirenic.eu`).** They are recorded here so that a
