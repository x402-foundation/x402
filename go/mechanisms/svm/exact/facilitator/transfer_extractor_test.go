...
const testWrappedTransferBlockhash = "5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF"
...
func buildWrappedTransferPayload(
	t *testing.T,
	...
	tx, err := solana.NewTransactionBuilder().
		...
		SetRecentBlockHash(solana.MustHashFromBase58(testWrappedTransferBlockhash)).
...
func TestVerifySupportsRegisteredTransferExtractors(t *testing.T) {
	...
	payload := buildWrappedTransferPayload(t, wrapperProgram, authority, feePayer, mint, payTo, 1_000_000)
