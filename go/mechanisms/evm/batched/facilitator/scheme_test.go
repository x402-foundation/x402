...
func (a *fakeAuthorizerSigner) SignClaimBatch(_ context.Context, _ []batched.BatchedVoucherClaim, _ string) ([]byte, error) {
	return []byte("sig"), nil
}
...
func newScheme() *BatchedEvmScheme {
	return NewBatchedEvmScheme(
