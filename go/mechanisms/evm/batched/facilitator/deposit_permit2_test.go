...
func goodPermit2Auth() *batched.BatchedPermit2Authorization {
	return &batched.BatchedPermit2Authorization{
		From: testPermit2Payer,
		Permitted: batched.BatchedPermit2TokenPermissions{
			Token:  testPermit2Token,
			Amount: "1000",
		},
		Spender:   batched.Permit2DepositCollectorAddress,
		Nonce:     "1",
		Deadline:  "9999999999",
		Witness:   batched.BatchedPermit2Witness{ChannelId: testPermit2ChannelId},
		Signature: "0x" + strings.Repeat("11", 65),
	}
}

func goodPermit2Config() batched.ChannelConfig {
