...
| [Agoragentic](https://agoragentic.com/services/) | Route agent tasks to x402 providers, receipt-backed, with reconciliation and discovery-audit services | TypeScript · Python | [GitHub](https://github.com/rhein1/agoragentic-integrations) · [npm](https://www.npmjs.com/package/agoragentic) |