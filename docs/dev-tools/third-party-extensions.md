...
| [TWZRD Agent Intel](https://intel.twzrd.xyz) | Solana-native trust scoring and signed x402 V5 receipt layer for AI agents. Free preflight checks + paid signed receipts via Streamable-HTTP MCP. | TypeScript | [Service](https://intel.twzrd.xyz) |
