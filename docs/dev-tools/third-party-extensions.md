...
description: "Packages built by ecosystem partners that extend x402 beyond the core specification."
---
...
| [x402 Registry](https://x402-registry.akrivis.workers.dev) | Permissionless crawl-verified discovery layer for x402 services: self-serve listing, sha256 manifest snapshots, MCP-searchable catalog | TypeScript | [GitHub](https://github.com/89rat/x402-registry) · [MCP](https://x402-registry.akrivis.workers.dev/mcp) |
| [x402 Payer](https://github.com/89rat/x402-registry/tree/main/payer) | Buyer-side MCP client: pays any x402 service automatically with a hard per-call spending cap and offline receipt verification | TypeScript | [GitHub](https://github.com/89rat/x402-registry/tree/main/payer) |
