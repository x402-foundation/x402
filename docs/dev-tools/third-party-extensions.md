...
| [Tollbridge](https://github.com/clawpipe/gate402) | Universal x402 gateway with an evidence layer: nine-attack certification (transparency registry), dispute resolution without card rails (P-VI), gateway conformance profile (P-VII), buyer-side policy (P-VIII), realized-price census | JavaScript (zero dependencies) | [GitHub](https://github.com/clawpipe/gate402) · [Protocol drafts](https://github.com/clawpipe/gate402/tree/main/governance/x402-foundation-contributions) |
