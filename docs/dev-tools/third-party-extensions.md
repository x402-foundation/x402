...
| [HCRB / Code402](https://hcrb.in) | Deterministic bank validation (ISO 7064 MOD-97 IBAN, BIC, RDAP domain age) & EAS settlement receipts on Base | HTTP, TypeScript, Python | [Docs](https://hcrb.in) · [Status](https://hcrb.in/status) · [Install](https://hcrb.in/install) |
