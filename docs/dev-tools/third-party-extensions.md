...
| [Magpie MCP](https://x402.magpie.capital) | MCP server exposing Magpie's x402 lending API as agent tools (pool state, simulate-borrow, conditional intents) for Claude, Cursor, and Windsurf | TypeScript | [GitHub](https://github.com/magpiecapital/magpie-x402) · [npm](https://www.npmjs.com/package/@magpieloans/magpie-mcp) |