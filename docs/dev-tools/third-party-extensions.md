...
| [AgentGate MCP](https://x402.agentsea.vn) | Zero-subscription AI utility microservices (Markdown scraping, Prompt Firewall, Solana token audit) | TypeScript / Node.js | [GitHub](https://github.com/teddiesloco/agentgate-mcp) · [Spec](https://x402.agentsea.vn/.well-known/x402) |
