...
| [Authorization Evidence](/extensions/authorization-evidence) | Server + Client | Pre-payment mandate verification through a pluggable external verifier | TypeScript |
