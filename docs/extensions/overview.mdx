...
| [Builder Code](./builder-code) | Server + Client + Facilitator | On-chain attribution tracking via ERC-8021 Schema 2. Appends CBOR-encoded builder codes to settlement transaction calldata. | TypeScript |
