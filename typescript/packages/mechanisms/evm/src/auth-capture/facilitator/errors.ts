/**
 * Named error reason constants for the auth-capture EVM facilitator.
 *
...
export const ErrInvalidAuthCaptureExtra = "invalid_auth_capture_extra";
...
export const ErrInvalidAuthCaptureSignature = "invalid_auth_capture_signature";
