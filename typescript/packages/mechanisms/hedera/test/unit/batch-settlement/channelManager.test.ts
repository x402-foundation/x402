...
import { keyTypeOf, signDigestWithPrivateKey } from "../../../src/batch-settlement/signing";
import {
...
const AUTHORIZER_KEY = PrivateKey.fromStringECDSA(
...
function buildAuthorizerSigner(): AuthorizerSigner {
  return {
    ...
    accountId: "0.0.4242",
    keyType: keyTypeOf(AUTHORIZER_KEY),
    signDigest: digest => signDigestWithPrivateKey(AUTHORIZER_KEY, digest),
  };
}
...
function buildManager(opts?: {
  ...
  const scheme = new BatchSettlementHederaScheme(RECEIVER, {
    storage,
