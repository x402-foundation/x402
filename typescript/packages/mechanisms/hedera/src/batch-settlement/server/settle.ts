 ...
 *
 * @param scheme - Owning `BatchSettlementHederaScheme` instance for storage and signer access.
 ...
 *
 * @param scheme - Owning `BatchSettlementHederaScheme` instance for snapshot access.
